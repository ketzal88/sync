...
import { Box, Grid, Typography, Divider, Button, TextField, MenuItem } from "@mui/material";
...
export default function ApartmentsPage() {
  ...
  const handlePisoChange = (e) => {
    ...
    if (value) {
      if (tipo) {
        setApartments([...DEFAULT_APARTMENTS.filter(a => a.piso === value && a.tipo === tipo)])
      } else {
  ...
  const handleTipoChange = (e) => {
    ...
    if (value) {
      if (piso) {
        setApartments([...DEFAULT_APARTMENTS.filter(a => a.tipo === value && a.piso === piso)])
      } else {
  ...
  return (
    <Grid container item className={classes.wrapper}>
          ...
          {apartments.map(apartment => (
            ...
            >
              ...
              >
                ...
                <Divider sx={{border: '4px solid #F1804F', width: '50%', marginBottom: '31px', marginTop: '20px'}} textAlign="left"/>
                <Grid item xl={12}>
                  <Box sx={{display: 'flex'}}>
                    <Typography
                      sx={{
                    ...
                    >
                      {apartment.piso}{pisoText(apartment.piso)} piso
                    </Typography>
                  </Box>
                  <Box sx={{display: 'flex'}}>
                    <Typography
              ...
              <Grid container item flexDirection="column" sx={{width: '25%'}}>
      ...
      <ScheduleInterviewModal open={open} handleClose={closeModal} apartment={currentApartment}/>
    </Grid>
  );
}
